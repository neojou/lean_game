 ...
 *
 * Compose Desktop draws with Skia, which does **not** pick up system CJK
 * fonts the same way a browser would. Without a bundled CJK face, Chinese
 * glyphs render as blank.
 */
@Composable
